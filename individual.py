...
class Individual:
    def __init__(self, length):
        self.genome = np.zeros([length, 3], dtype=int)
        self.length = length
    ...
    def mutate_new(self, percent_of_information_to_mutate, max_change_in_coords = 10):
    ...
    def print_genome(self):
        for i in range(0, self.length):
            ...
            print(i, self.genome[i, 0], self.genome[i, 1], " - ", self.shapes[shape_index][0], self.shapes[shape_index][1])
